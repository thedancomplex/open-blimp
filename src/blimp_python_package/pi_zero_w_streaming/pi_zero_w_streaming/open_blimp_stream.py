...
class ThreadedStream:
  def __init__(self, udp_ip, only_cam=False, only_imu=False, only_dist=False, udp_ports=(8485, 8486, 8487), uart_port="/dev/serial0", res=(128, 128), quality=10, fps=5, hz=30):
...
if __name__ == "__main__":
  ...
  parser.add_argument('--dist_only', dest='dist', action='store_true')

  args = parser.parse_args()
  udp_ip = '192.168.3.101'
