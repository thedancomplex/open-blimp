...
class ThreadedPiStream:
  ...
  def get_trio(self):
    ...
    self.bno_new = False
    self.dist_new = False
    return self.cam_stamp, self.bno_stamp, self.dist_stamp, self.img, (self.rot, self.gyro, self.acc), self.distance
  ...
  def handle_dist_read(self):
    ...
    while True:
      ...
      if data:
        distance = struct.unpack("<2d", data)
        self.distance = distance[0]
        self.dist_stamp = distance[1]
        self.dist_new = True
