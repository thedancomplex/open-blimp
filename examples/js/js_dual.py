...
b1 = Blimp(1, ser, (1111, 1112, 1113))
b2 = Blimp(2, ser, (2221, 2222, 2223))
...
try:
    while running:
        ...
        # decide inputs
        if on1:
            des1[0] = np.clip(des1[0] - 0.05*ax[3], 0.5, 2.5)
            des1[1] = -ax[0]
            des1[2] = -ax[1]
            des1[3] = wrap(des1[3] + 0.05*ax[2])
            b1.set_des(des1)

        elif on2:
            des2[0] = np.clip(des2[0] - 0.05*ax[3], 0.5, 2.5)
            des2[1] = -ax[0]
            des2[2] = -ax[1]
            des2[3] = wrap(des2[3] + 0.05*ax[2])
            b2.set_des(des2)
